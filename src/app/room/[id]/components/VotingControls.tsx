...
export default function VotingControls({
	...
	return (
		<div className='flex-2 max-w-6xl bottom-2 left-0 right-0 dark:bg-gray-800 py-2 md:py-4'>
			<div className='max-w-6xl mx-auto flex flex-wrap gap-2 md:gap-4 justify-center'>
